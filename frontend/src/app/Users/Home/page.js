...
import smartHire from "../../Photos/smarthire.jpeg"
        ...
        <div className="bg-[#F4F2EE] min-h-screen text-gray-800 font-sans">
            ...
            <header className="pt-20 bg-[#F4F2EE] border-b border-gray-300">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center md:text-left flex flex-col md:flex-row items-center md:space-x-12">
                    <div className="md:w-1/2 space-y-6">
                        <h1 className="text-4xl sm:text-5xl font-extrabold text-[#0073b1] leading-snug mb-4">
                    ...
                    <div className="md:w-1/2 mt-10 md:mt-0 flex justify-center">
                        <Image
                            src={smartHire.src}
                            alt="AI Recruitment"
                            className="w-full max-w-sm sm:max-w-md md:max-w-lg object-contain rounded-lg shadow-lg"
                            width={500}
                            height={400}
                            priority
                        />
            ...
            <section className="py-16 bg-[#F4F2EE] text-center border-t border-gray-200">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-semibold text-[#0073b1] mb-6">
