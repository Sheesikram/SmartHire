...
const Dashboard = () => {
    ...
    return (
        <div className="container mx-auto p-6 min-h-screen flex flex-col space-y-8 bg-gray-100 mt-[3.75rem]">
            ...
            <section>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {subscriptionData.map((sub, index) => (
                        <div
                            key={index}
                            className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center border-l-4 border-[#0073b1] transition-transform transform hover:scale-105"
                        >
                            <div className="mb-4">
                                {sub.type === "Jobs" ? (
                                    <FontAwesomeIcon icon={faBriefcase} className="w-12 h-12 text-black" />
                                ) : (
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#0073b1]">
                    <h3 className="text-lg font-semibold text-gray-800 mb-4">Job Posts Per Day</h3>
                    <Line
                        data={lineChartData}
                        options={{
                            responsive: true,
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#0073b1]">
                    <h3 className="text-lg font-semibold text-gray-800 mb-4">Job Posts by Category</h3>
                    <Bar
                        data={barChartData}
                        options={{
                            responsive: true,
            ...
            {/* Pie and Doughnut Charts Section */}
            {/* Pie and Doughnut Charts Section */}
            <section className="grid sm:grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-[#0073b1] transform transition duration-300 hover:shadow-xl overflow-hidden">
                    <h3 className="text-lg font-semibold text-gray-800 mb-4">Workplace Distribution</h3>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-[#0073b1] transform transition duration-300 hover:shadow-xl overflow-hidden">
                    <h3 className="text-lg font-semibold text-gray-800 mb-4">Job Post Preferences</h3>
                    <div className="w-full h-64 relative">
                        <Doughnut
